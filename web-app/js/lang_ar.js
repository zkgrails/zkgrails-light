...
msgzul={};msgzul.UNKNOWN_TYPE="نوع غير معروف";msgzul.DATE_REQUIRED="يتطلب وجود تاريخ";msgzul.OUT_OF_RANGE="خارج الحدود المسموح بها";msgzul.NO_AUDIO_SUPPORT="لا يوجد دعم للصوت";
zk.$default(msgzul, {
...
ABORT:'خروج',
IGNORE:'تجاهل',
UPLOAD_CANCEL:'تم الغاء الرفع',
ILLEGAL_VALUE:'قيمة غير قانونية'});
