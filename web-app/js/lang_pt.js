...
mesg={};mesg.NOT_FOUND="Não encontrado: ";mesg.UNSUPPORTED="Ainda não suportado: ";mesg.FAILED_TO_SEND="Falhou ao enviar requisição para o servidor.";mesg.FAILED_TO_RESPONSE="O servidor falhou ao processar sua requisição.";mesg.TRY_AGAIN="Tentar novamente?";mesg.UNSUPPORTED_BROWSER="Navegador não suportado: ";mesg.ILLEGAL_RESPONSE="Resposta desconhecida enviada pelo servidor. Por favor, recarregue e tente novamente.\n";mesg.FAILED_TO_PROCESS="Falhou ao processar ";mesg.GOTO_ERROR_FIELD="Ir para o campo errado";mesg.PLEASE_WAIT="Processando...";mesg.FILE_SIZE="Tamanho do arquivo: ";mesg.KBYTES="KB";mesg.FAILED_TO_LOAD="Falhou ao carregar ";mesg.FAILED_TO_LOAD_DETAIL="Isto pode ser causado por um mau tráfego. Você pode recarregar esta página e tentar novamente.";mesg.CAUSE="Causa: ";mesg.LOADING="Processando...";
zk.GROUPING=".";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
...
msgzul={};msgzul.UNKNOWN_TYPE="Tipo de componente desconhecido: ";msgzul.DATE_REQUIRED="Você deve especificar uma data. Formato: ";msgzul.OUT_OF_RANGE="Fora de faixa";msgzul.NO_AUDIO_SUPPORT="Seu navegador não suporta áudio dinâmico";
zk.$default(msgzul, {
