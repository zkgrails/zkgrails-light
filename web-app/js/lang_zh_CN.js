...
mesg={NOT_FOUND:"找不到：",UNSUPPORTED:"尚未支持：",FAILED_TO_SEND:"无法传送资料到服务器。",FAILED_TO_RESPONSE:"伺服器暂时无法处理你的请求。",TRY_AGAIN:"再试一次?",UNSUPPORTED_BROWSER:"尚未支持你使用的浏览器：",ILLEGAL_RESPONSE:"无法辨识服务器传回的资料。请按重新载入，再试试。\n",FAILED_TO_PROCESS:"无法处理：",GOTO_ERROR_FIELD:"回错误栏",PLEASE_WAIT:"处理中，请稍候…",FILE_SIZE:"文件大小：",KBYTES:"KB",FAILED_TO_LOAD:"无法载入：",FAILED_TO_LOAD_DETAIL:"可能是连线问题，请按重载再试一次。",CAUSE:"原因：",LOADING:"载入中..."};
zk.GROUPING=",";
zk.DECIMAL=".";
zk.PERCENT="%";
zk.MINUS="-";
...
msgzul={UNKNOWN_TYPE:"未知元件类型：",DATE_REQUIRED:"只能输入日期。格式：",OUT_OF_RANGE:"超出范围",NO_AUDIO_SUPPORT:"你的浏览器不支持动态音效"};
zk.$default(msgzul, {
